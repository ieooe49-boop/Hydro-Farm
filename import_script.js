...
// PASTE THIS INTO YOUR BROWSER CONSOLE TO IMPORT HISTORICAL DATA
...
const historicalData = [
  {
    "unit": "historical-indoor",
    "unitName": "Historical Indoor (Window A)",
    "originalLocation": "Window A",
    "crop": "Basil",
    "amount": 8.0,
    "volunteer": "Historical Import",
    "timestamp": 1690848000000
  },
  {
    "unit": "historical-indoor",
    "unitName": "Historical Indoor (Wall B)",
    "originalLocation": "Wall B",
    "crop": "Basil",
    "amount": 14.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-indoor",
    "unitName": "Historical Indoor (Window B)",
    "originalLocation": "Window B",
    "crop": "Parsley",
    "amount": 12.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-indoor",
    "unitName": "Historical Indoor (Wall A)",
    "originalLocation": "Wall A",
    "crop": "Parsley",
    "amount": 5.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (D1)",
    "originalLocation": "D1",
    "crop": "Parsley",
    "amount": 5.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (C1)",
    "originalLocation": "C1",
    "crop": "Parsley",
    "amount": 15.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (B1)",
    "originalLocation": "B1",
    "crop": "Parsley",
    "amount": 10.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (A1)",
    "originalLocation": "A1",
    "crop": "Parsley",
    "amount": 5.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (C2)",
    "originalLocation": "C2",
    "crop": "Basil",
    "amount": 10.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (D2)",
    "originalLocation": "D2",
    "crop": "Basil",
    "amount": 13.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (E1)",
    "originalLocation": "E1",
    "crop": "Parsley",
    "amount": 10.0,
    "volunteer": "Historical Import",
  ...
  {
    "unit": "historical-unknown",
    "unitName": "Historical Unknown (Wa;; N)",
    "originalLocation": "Wa;; N",
    "crop": "Basil",
    "amount": 4.0,
    "volunteer": "Historical Import",
    "timestamp": 1756166400000
  ...
  {
    "unit": "historical-outdoor",
    "unitName": "Historical Outdoor (F1)",
    "originalLocation": "F1",
    "crop": "Sage",
    "amount": 5.0,
    "volunteer": "Historical Import",
...
// Load existing data
const existingData = localStorage.getItem('hydroData');
const data = existingData ? JSON.parse(existingData) : {};

// Add historical harvests
if (!data.harvests) data.harvests = [];
data.harvests = [...historicalData, ...data.harvests];

// Save back
localStorage.setItem('hydroData', JSON.stringify(data));

console.log('✅ Successfully imported 380 historical harvests!');
console.log('Total harvests now:', data.harvests.length);
